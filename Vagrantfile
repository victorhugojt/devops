...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ngnix" do |ngnix|
    ...
    ngnix.vm.provision "file", source: "/Users/victor.jimenezt/study/devops/devops_iac/startup/ngnix/docker-compose.yaml", destination: "./docker-compose.yaml"
 ...
 config.vm.define "auth" do |auth|
   ...
   auth.vm.provision "file", source: "/Users/victor.jimenezt/study/devops/devops_iac/startup/auth-api/env.list", destination: "./env.list"
   auth.vm.provision "shell", path: "/Users/victor.jimenezt/study/devops/devops_iac/startup/auth-api/auth.sh"
 end
 ...
 config.vm.define "todos" do |todos|
   ...
   todos.vm.provision "file", source: "/Users/victor.jimenezt/study/devops/devops_iac/startup/todos-api/env.list", destination: "./env.list"
   todos.vm.provision "shell", path: "/Users/victor.jimenezt/study/devops/devops_iac/startup/todos-api/todos.sh"
 end
